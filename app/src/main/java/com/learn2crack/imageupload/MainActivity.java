...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String URL = "https://api.imgbb.com/1/";
        ...
        call.enqueue(new Callback<Response>() {
            ...
            public void onResponse(Call<Response> call, retrofit2.Response<Response> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    //Snackbar.make(findViewById(R.id.content), responseBody.getUrl(),Snackbar.LENGTH_SHORT).show();
                    ...
                    try {
                        ...
                        //Snackbar.make(findViewById(R.id.content), errorResponse.getUrl(),Snackbar.LENGTH_SHORT).show();
